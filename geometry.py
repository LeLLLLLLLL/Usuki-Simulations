...
def update_plot(option, wire, qpcgap, qpcheight, vdiag_val, ny, xmax, ymax, n=None):
...
wire_input = FloatText(value=300.0, description='Wire:', layout=Layout(width='150px'))
qpcgap_input = FloatText(value=300.0, description='QPC Gap:', layout=Layout(width='150px'))
qpcheight_input = FloatText(value=500.0, description='QPC Length:', layout=Layout(width='150px'))
...
ymesh_input = IntText(value=200, description="Y Mesh:", layout=Layout(width='150px'))
xmax = IntText(value=4000, description="X Axis Max:", layout=Layout(width='150px'))
ymax = IntText(value=7000, description="Y Axis Max:", layout=Layout(width='150px'))
...
tabs = Tab(children=[
    ...
    VBox([HBox([xmax, ymax, ymesh_input])])
])
